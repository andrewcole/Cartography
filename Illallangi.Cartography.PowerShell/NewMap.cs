...
namespace Illallangi.Cartography.PowerShell
{
    ...
    public class NewMap : Cmdlet
    {
            ...
            set
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        nullable = value;
                        bool flag2;
                        if (minLat.GetValueOrDefault() <= nullable.GetValueOrDefault())
                        {
                            flag2 = false;
                        }
                        else
            ...
            set
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        nullable = value;
                        bool hasValue2;
                        if (minLon.GetValueOrDefault() >= nullable.GetValueOrDefault())
                        {
                            hasValue2 = false;
                        }
                        else
        ...
        private double? MaxLat { get; set; }
        
        private double? MaxLon { get; set; }
        
        private double? MinLat { get; set; }
        
        private double? MinLon { get; set; }
        ...
        private GeoLine BoundingBox
        {
            get
            {
                ...
                if (maxLat.HasValue)
                {
                    valueOrDefault = maxLat.GetValueOrDefault();
                }
                else
                {
                    valueOrDefault = 0;
                ...
                double padding = valueOrDefault + this.Padding;
                maxLat = this.MaxLon;
                if (maxLat.HasValue)
                {
                    num = maxLat.GetValueOrDefault();
                }
                else
                {
                    num = 0;
                ...
                GeoPoint geoPoint = GeoPoint.FromDegrees(padding, num + this.Padding);
                maxLat = this.MinLat;
                if (maxLat.HasValue)
                {
                    valueOrDefault1 = maxLat.GetValueOrDefault();
                }
                else
                {
                    valueOrDefault1 = 0;
                ...
                double padding1 = valueOrDefault1 - this.Padding;
                maxLat = this.MinLon;
                if (maxLat.HasValue)
                {
                    num1 = maxLat.GetValueOrDefault();
                }
                else
                {
                    num1 = 0;
                ...
                var geoLine = new GeoLine(geoPoint, GeoPoint.FromDegrees(padding1, num1 - this.Padding));
                return geoLine;
            }
        }
